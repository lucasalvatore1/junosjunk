# Script using Juniper pyez to roll out changes to a list of devices
# Requires a file called "commands" with the commands you want (in "set" style"
# Requires a file called "switchlist" which has the list of devices you want to change
